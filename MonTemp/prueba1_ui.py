...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1178, 575)
        MainWindow.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.frame_4 = QtWidgets.QFrame(self.centralwidget)
        self.frame_4.setGeometry(QtCore.QRect(740, 50, 421, 471))
...
"background-color: rgb(85, 85, 127);")
        ...
        self.frame.setGeometry(QtCore.QRect(10, 60, 231, 111))
        ...
        self.grafica1.setGeometry(QtCore.QRect(30, 40, 181, 21))
        ...
        self.grafica2.setGeometry(QtCore.QRect(30, 70, 201, 21))
        self.grafica2.setChecked(True)
        self.grafica2.setObjectName("grafica2")
        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(50, 10, 71, 31))
        self.label.setObjectName("label")
        self.frame_2 = QtWidgets.QFrame(self.frame_4)
        self.frame_2.setGeometry(QtCore.QRect(10, 180, 231, 111))
        ...
        self.radioButton_2.setGeometry(QtCore.QRect(20, 80, 211, 20))
        self.radioButton_2.setChecked(True)
        self.radioButton_2.setObjectName("radioButton_2")
        self.radioButton = QtWidgets.QRadioButton(self.frame_2)
        self.radioButton.setEnabled(False)
        self.radioButton.setGeometry(QtCore.QRect(20, 50, 71, 21))
        ...
        self.SetPoint1 = QtWidgets.QCheckBox(self.frame_3)
        self.SetPoint1.setEnabled(False)
        self.SetPoint1.setGeometry(QtCore.QRect(20, 190, 85, 21))
        self.SetPoint1.setObjectName("SetPoint1")
        self.heater1 = QtWidgets.QCheckBox(self.frame_3)
        self.heater1.setEnabled(False)
        self.heater1.setGeometry(QtCore.QRect(20, 210, 85, 21))
        self.heater1.setObjectName("heater1")
        self.SetPoint2 = QtWidgets.QCheckBox(self.frame_3)
        self.SetPoint2.setEnabled(False)
        self.SetPoint2.setGeometry(QtCore.QRect(20, 230, 85, 21))
        self.SetPoint2.setObjectName("SetPoint2")
        self.heater2 = QtWidgets.QCheckBox(self.frame_3)
        self.heater2.setEnabled(False)
        self.heater2.setGeometry(QtCore.QRect(20, 250, 85, 21))
        self.heater2.setObjectName("heater2")
        self.label_4 = QtWidgets.QLabel(self.frame_4)
        self.label_4.setGeometry(QtCore.QRect(140, 10, 171, 31))
        self.label_4.setObjectName("label_4")
        self.frame_5 = QtWidgets.QFrame(self.centralwidget)
        self.frame_5.setGeometry(QtCore.QRect(10, 40, 721, 241))
        self.frame_5.setStyleSheet("background-color: rgb(48, 176, 255);")
        self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_5.setObjectName("frame_5")
        self.label_5 = QtWidgets.QLabel(self.frame_5)
        self.label_5.setGeometry(QtCore.QRect(240, 10, 261, 31))
        self.label_5.setObjectName("label_5")
        self.scrollArea = QtWidgets.QScrollArea(self.frame_5)
        self.scrollArea.setGeometry(QtCore.QRect(10, 50, 701, 141))
        self.scrollArea.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 699, 139))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.verticalScrollBar = QtWidgets.QScrollBar(self.scrollAreaWidgetContents)
        self.verticalScrollBar.setEnabled(True)
        self.verticalScrollBar.setGeometry(QtCore.QRect(680, 0, 21, 141))
        ...
        self.lastdata.setGeometry(QtCore.QRect(270, 200, 181, 23))
        self.lastdata.setObjectName("lastdata")
        self.frame_6 = QtWidgets.QFrame(self.centralwidget)
        self.frame_6.setGeometry(QtCore.QRect(10, 290, 721, 231))
        self.frame_6.setStyleSheet("background-color: rgb(11, 93, 148);")
        self.frame_6.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_6.setObjectName("frame_6")
        self.label_6 = QtWidgets.QLabel(self.frame_6)
        self.label_6.setGeometry(QtCore.QRect(220, 0, 261, 31))
        ...
        self.setPoint_num_1.setGeometry(QtCore.QRect(100, 30, 71, 24))
        ...
        self.ramp_1.setGeometry(QtCore.QRect(250, 30, 51, 24))
        ...
        self.range_1.setGeometry(QtCore.QRect(230, 60, 101, 23))
        ...
        self.frame_9.setGeometry(QtCore.QRect(70, 60, 161, 21))
        ...
        self.range_automatic_1.setGeometry(QtCore.QRect(0, 0, 91, 21))
        ...
        self.range_manual_1.setGeometry(QtCore.QRect(90, 0, 71, 21))
        ...
        self.heater_1.setGeometry(QtCore.QRect(120, 10, 141, 21))
        font = QtGui.QFont()
...
"background-color: rgb(255, 59, 25);")
        ...
        self.setPoint_num_2.setGeometry(QtCore.QRect(100, 30, 71, 24))
        ...
        self.range_2.setGeometry(QtCore.QRect(230, 60, 101, 23))
        ...
        self.heater_2.setGeometry(QtCore.QRect(110, 10, 141, 21))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.frame_10.setGeometry(QtCore.QRect(70, 60, 161, 21))
        ...
        self.range_automatic_2.setGeometry(QtCore.QRect(0, 0, 91, 21))
        ...
        self.range_manual_2.setGeometry(QtCore.QRect(90, 0, 71, 21))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(300, 0, 601, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; color:#aaffff;\">Plot of Data</span></p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; color:#00557f;\">Acquisition of Data</span></p></body></html>"))
        self.scrollArea.setToolTip(_translate("MainWindow", "<html><head/><body><p>ik</p><p>nkmkl</p><p>mklm</p></body></html>"))
        ...
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">Address:</span></p></body></html>"))
