...
class Ui_plot_file(object):
    def setupUi(self, plot_file):
        ...
        plot_file.resize(557, 123)
        self.buttonBox = QtWidgets.QDialogButtonBox(plot_file)
        self.buttonBox.setGeometry(QtCore.QRect(170, 80, 191, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.control = QtWidgets.QLineEdit(plot_file)
        self.control.setGeometry(QtCore.QRect(260, 20, 281, 21))
        self.control.setStyleSheet("font: 12pt \"Sans Serif\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 50, 251, 21))
